...
RSpec.describe "tbl_quality_issues/new", type: :view do
  before(:each) do
    assign(:tbl_quality_issue, TblQualityIssue.new(
  ...
  it "renders new tbl_quality_issue form" do
    render

    assert_select "form[action=?][method=?]", tbl_quality_issues_path, "post" do
