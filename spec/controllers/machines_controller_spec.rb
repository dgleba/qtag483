...
RSpec.describe MachinesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: machine.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      machine = Machine.create! valid_attributes
      get :edit, params: {id: machine.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Machine" do
        expect {
          post :create, params: {machine: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {machine: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested machine" do
        machine = Machine.create! valid_attributes
        put :update, params: {id: machine.to_param, machine: new_attributes}, session: valid_session
        machine.reload
      ...
      it "redirects to the machine" do
        machine = Machine.create! valid_attributes
        put :update, params: {id: machine.to_param, machine: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        machine = Machine.create! valid_attributes
        put :update, params: {id: machine.to_param, machine: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested machine" do
      machine = Machine.create! valid_attributes
      expect {
        delete :destroy, params: {id: machine.to_param}, session: valid_session
      }.to change(Machine, :count).by(-1)
    end
