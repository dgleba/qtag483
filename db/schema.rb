...
ActiveRecord::Schema.define(version: 5016_12_30_223301) do
  ...
  create_table "active_storage_attachments", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
  ...
  create_table "active_storage_blobs", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
  ...
  create_table "country_of_origins", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
    t.string "name"
    t.datetime "fdate"
    t.integer "active_status"
  ...
  create_table "examples", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
    t.string "name"
    t.string "colour"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "product_features", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
    t.string "name"
    t.bigint "product_id"
  ...
  create_table "products", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
    t.string "name"
  ...
  create_table "roles", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.integer "active_status"
    t.integer "sort"
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
  ...
  create_table "versions", options: "ENGINE=InnoDB DEFAULT CHARSET=ascii", force: :cascade do |t|
